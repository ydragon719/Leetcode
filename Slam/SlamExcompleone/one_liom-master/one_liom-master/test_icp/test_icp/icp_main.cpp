...
int main(int argc, char** argv)
{
    ...
    if (pcl::io::loadPCDFile<PointType>("/home/eminbogen/test/test_icp/data/x_5/34laser.pcd", *cloud_laser )== -1)
    {
        PCL_ERROR("Couldn't read file laser_pcd.pcd\n");
        return(-1);
    }
    if (pcl::io::loadPCDFile<PointType>("/home/eminbogen/test/test_icp/data/x_5/34map.pcd", *cloud_map )== -1)
    {
    ...
    ss << pcd_count;
    ss >> str;
    std::string pcd_path = "/home/eminbogen/test/test_icp/data/";
